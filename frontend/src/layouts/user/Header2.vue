<template>
  ...
  <div class="main-header">
    <div class="container d-flex align-items-center justify-content-between">
      <!-- Logo -->
      <div class="logo">
        <router-link :to="{name: 'home'}"><img src="../../assets/image/PHoneZone.png" alt="Logo" /></router-link>
      </div>
      ...
      <div class="icon-group d-flex align-items-center gap-3 text-white">
        ...
        <router-link :to="{ name: 'dashboard' }" class="d-flex align-items-center gap-1" v-if="hasScope(['ROLE_ADMIN','ROLE_MANAGER','ROLE_SHIFT_STAFF'])">
