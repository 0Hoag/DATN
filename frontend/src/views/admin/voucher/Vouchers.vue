        ...
        <div class="row">
          ...
          <div class="col-6 mb-3">
            ...
            <input
              ...
              id="addDescription"
              placeholder="Mô tả"
              v-model="voucherModel.description"
              required
            />
          </div>
          <div class="col-6 mb-3">
            ...
            <input
              ...
              id="addDiscountValue"
              placeholder="Giá trị"
              v-model="voucherModel.discountValue"
              required
            />
          </div>
          <div class="col-6 mb-3">
            <label for="addMinOrderValue" class="form-label fw-bold"
            ...
            <input
              ...
              v-model="voucherModel.minOrderValue"
              required
            />
          </div>
          <div class="col-6 mb-3">
            <label for="addMaxUsageCount" class="form-label fw-bold"
        ...
        <div class="row">
          ...
          <div class="col-6 mb-3">
            ...
            <input
              ...
              id="editDescription"
              placeholder="Mô tả"
              v-model="voucherModelEdit.description"
              required
            />
          </div>
          <div class="col-6 mb-3">
            ...
            <input
              ...
              placeholder="Giá trị"
              v-model="voucherModelEdit.discountValue"
              required
            />
          </div>
          <div class="col-6 mb-3">
            <label for="editMinOrderValue" class="form-label fw-bold"
              >Giá trị đơn hàng tối thiểu</label
            >
            <input
              type="number"
              ...
              placeholder="Giá trị đơn hàng tối thiểu"
              v-model="voucherModelEdit.minOrderValue"
              required
            />
          </div>
          <div class="col-6 mb-3">
            <label for="editMaxUsageCount" class="form-label fw-bold"
              >Số lượt dùng tối đa</label
            >
            <input
              type="number"
              ...
              placeholder="Số lượt dùng tối đa"
              v-model="voucherModelEdit.quantity"
              required
            />
          </div>
          <div class="col-6 mb-3">
            ...
            <input
              ...
              class="form-control"
              id="editStart_at"
              v-model="voucherModelEdit.startAt"
              required
            />
          </div>
          <div class="col-6 mb-3">
            ...
            <input
              ...
              class="form-control"
              id="editEnd_at"
              v-model="voucherModelEdit.endAt"
              required
            />
          </div>
...
function getFormEdit() {
  return {
    ...voucherModelEdit.value,
    startAt: toStartOfDay(voucherModelEdit.value.startAt),
    endAt: toEndOfDay(voucherModelEdit.value.endAt),
    isActive: dayjs(voucherModelEdit.value.endAt).isAfter(voucherModelEdit.value.startAt),
  };
}
