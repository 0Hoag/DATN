...
public class VoucherUsageController {
    ...
    @GetMapping("/can-use")
    public ApiResponse<Boolean> canUserUseVoucher(@RequestParam Integer userId, @RequestParam Integer voucherId) {
    ...
    public ApiResponse<Void> markVoucherAsUsed(@RequestParam Integer userId, @RequestParam Integer voucherId) {
    ...
    public ApiResponse<Boolean> checkVoucherUsed(@RequestParam Integer userId, @RequestParam Integer voucherId) {
        return ApiResponse.<Boolean>builder()
