...
public class EmailService {
    ...
    public String verifyEmail(String email) {
        var user = userRepository.findByEmail(email).orElseThrow(() -> new AppException(ErrorCode.EMAIL_INCORRECT));

        forgotPasswordRepository.findByUser(user).ifPresent(fp -> forgotPasswordRepository.deleteById(fp.getFpId()));
    ...
    public String verifyOtp(Integer otp, String email) {
        ...
        var fp = forgotPasswordRepository
