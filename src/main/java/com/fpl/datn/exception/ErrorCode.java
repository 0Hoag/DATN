...
public enum ErrorCode {
    ...
    PRODUCT_IMAGE_DETAIL_EXISTED(1507, "Product image detail already exists", HttpStatus.CONFLICT),
    PRODUCT_IMAGE_UPDATE_EXISTED(1508, "Product image update already exists", HttpStatus.CONFLICT),
    PRODUCT_IMAGE_DELETE_EXISTED(1509, "Product image delete already exists", HttpStatus.CONFLICT),
