...
public enum ErrorCode {
    ...
    INVALID_REQUEST(7000, "Invalid request", HttpStatus.BAD_REQUEST),
    ...
    INVALID_PARENT_ID(1021, "Invalid parent ID", HttpStatus.BAD_REQUEST),
    ...
    PRODUCT_NAME_EXISTED(1024, "Product name existed", HttpStatus.CONFLICT),
    ...
    PRODUCT_TYPE_NAME_EXISTED(1027, "Product type name existed", HttpStatus.CONFLICT),
    ...
    SPECIFICATION_TYPE_NAME_EXISTED(1030, "Specification type name existed", HttpStatus.CONFLICT),

    CART_NOT_EXISTED(1031, "Cart not existed", HttpStatus.BAD_REQUEST),
    CART_EXISTED(1032, "Cart existed", HttpStatus.BAD_REQUEST),
    CART_NAME_EXISTED(1033, "Cart name existed", HttpStatus.CONFLICT),
    ...
    CART_DETAIL_NAME_EXISTED(1036, "Cart detail name existed", HttpStatus.CONFLICT),

    ORDERS_STATUS_NOT_EXISTED(1037, "Order status not existed", HttpStatus.BAD_REQUEST),
    ORDERS_STATUS_EXISTED(1038, "Order status existed", HttpStatus.BAD_REQUEST),
    ORDERS_STATUS_NAME_EXISTED(1039, "Order status name existed", HttpStatus.CONFLICT),

    ADDRESS_NOT_EXISTED(1040, "Address not existed", HttpStatus.BAD_REQUEST),
    ADDRESS_EXISTED(1041, "Address existed", HttpStatus.BAD_REQUEST),
    ADDRESS_NAME_EXISTED(1042, "Address name existed", HttpStatus.CONFLICT),

    SPECIFICATION_NOT_FOUND(1043, "Specification not found", HttpStatus.NOT_FOUND),
    SPECIFICATION_EXISTED(1044, "Specification existed", HttpStatus.BAD_REQUEST),
    SPECIFICATION_NAME_EXISTED(1045, "Specification name existed", HttpStatus.CONFLICT),

    ORDER_DETAIL_NOT_FOUND(1046, "Order detail not found", HttpStatus.BAD_REQUEST),
    INVALID_QUANTITY(1047, "Invalid quantity", HttpStatus.BAD_REQUEST),
    INVALID_INPUT(1100, "Invalid input", HttpStatus.BAD_REQUEST),
    SEND_EMAIL_ERROR(1048, "Send email error", HttpStatus.BAD_REQUEST),
